...
$players->sendMessage(TextFormat::GREEN . "[+] ".TextFormat::YELLOW.$this->getPlayer()->getName());
$player = $event->getPlayer();
...
$players->SendMessage(TextFormat::RED."[-] ".TextFormat::YELLOW.$this->getPlayer()->getName());
}
}
?>
